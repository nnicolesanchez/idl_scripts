pro galnumfraction,plotter=plotter,plottitle=plottitle,dolegend=dolegend
...
if keyword_set(plotter) then paperplot,filename='h258gasfraction.ps'

plot,redshifts,clumpyfrac,xtit='Redshift',ytit='Gas Particle Fraction',xra=[4.5,0],xstyle=1,yra=[0,1],linestyle=0,thick=3,title=plottitle
  oplot,redshifts,clumpyfrac,color=90,linestyle=0,thick=3;,psym=-1
  oplot,redshifts,coldfrac,color=60,linestyle=0,thick=3
  oplot,redshifts,shockedfrac,color=170,linestyle=0
...
if keyword_set(dolegend) then legend,['cold','clumpy','shocked','early'],colors=[60,90,170,0],lines=[0,0,0,0],/right,charsize=1,position=[0.1,0.98]
