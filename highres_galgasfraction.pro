pro highres_galgasfraction,plotter=plotter,plottitle=plottitle,dolegend=dolegend
...
;print,nfiles
file=file[1:nfiles-1]           ; have to do this because gas isn't accreted until 00072
...
;redshifts = redshifts[where (redshifts ge 0. AND redshifts le 15)]
;redshifts = [4.5,reverse(redshifts)]
redshifts = reverse(redshifts)
...
plot,redshifts,clumpymass/totalmass,xtit='Redshift',ytit='Gas Mass Fraction',xstyle=1,yra=[0,1],linestyle=0,thick=3,title=plottitle
  oplot,redshifts,clumpymass/totalmass,color=90,linestyle=0,thick=3;,psym=-1
  oplot,redshifts,coldmass/totalmass,color=60,linestyle=0,thick=3
;  oplot,redshifts,shockedmass/totalmass,color=170,linestyle=0
;  oplot,redshifts,earlymass/totalmass,color=0,linestyle=0,thick=3

clumpygalfraction=clumpymass/totalmass
coldgalfraction=coldmass/totalmass
print,clumpygalfraction[43]
print,coldgalfraction[43]

stop

if keyword_set(dolegend) then legend,['cold','clumpy'],colors=[60,90],lines=[0,0],/right,charsize=1,position=[0.1,0.98]


if keyword_set(dolegend) then legend,['BH','galaxy'],colors=[0,0],lines=[2,0],thick=[4,4],charsize=1,position=[2.9,0.98]
...
;print,earlyfraction[260396]
    ...
    oplot,dmtimez,clumpyfraction,color=90,linestyle=2
    oplot,dmtimez,coldfraction,color=60,linestyle=2
;    oplot,dmtimez,shockedfraction,color=210,linestyle=2
;    oplot,dmtimez,earlyfraction,color=0,linestyle=2
; testing
