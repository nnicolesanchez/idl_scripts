pro galgasfraction_otherh277,plotter=plotter,plottitle=plottitle,dolegend=dolegend
...
redshifts = redshifts[where (redshifts ge 0. AND redshifts le 4.9)]
print,n_elements(redshifts)
...
plot,redshifts,clumpymass/totalmass,xtit='Redshift',ytit='Gas Mass Fraction',xra=[4.5,0],xstyle=1,yra=[0,1],linestyle=0,thick=3,title=plottitle
