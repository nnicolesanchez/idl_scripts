...
readcol,'out.dm',w,bhiords,w,delta,w,dmtime,w,w,dm,format='a,l,a,f,a,f,a,a,f',/silent
loadct,39
...
bhorbitmass = bhorbits[43].mass*munit
bhorbittime = bhorbits[43].time*tunit
...
plot,dmtime*tunit,alltotal,xtit='Time (Gyr)',ytit='Cumulative BH Mass',/ylog,yra=[100,1e7],xstyle=8;,xrange=[0,14]
   oplot,clumpybhtimes*tunit,clumpytotal,color=95;,psym=3
   oplot,bhorbittime,bhorbitmass,lines=2,color=20
...
;######  LEGEND FOR h277_allgasmass PLOT  ##### 
;##(currently off b/c it runs into the data)##
