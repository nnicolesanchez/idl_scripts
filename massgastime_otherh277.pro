pro massgastime_otherh277,plotter=plotter
...
plot,bindmtime*tunit,bindm*munit,xtit='time (Gyr)',ytit='mass accreted by central BH',/ylog,yra=[1,1e8],xra=[0,14]
...
plot,dmtime*tunit,alltotal,xtit='Time (Gyr)',ytit='Cumulative BH Mass',/ylog,yra=[100,1e8],xra=[0,14],xstyle=1
   oplot,clumpybhtimes*tunit,clumpytotal,color=95;,psym=3
   oplot,bhorbittime,bhorbitmass,lines=2,color=20
   oplot,coldbhtimes*tunit,coldtotal,lines=3,color=50;,psym=3
    if numshocked gt 0 then  oplot,shockedbhtimes*tunit,shockedtotal,lines=1,color=170;,psym=3
;   oplot,earlybhtimes*tunit,earlytotal,color=50;,psym=3

help,bhorbittime
help,bhorbitmass 

legend,['total BH mass','total gas','cold','shocked','clumpy'],lines=[2,0,3,1,0],color=[20,0,50,170,95],charsize=1,/right,/bottom

axis,xaxis=1,xtit='Redshift',xtickv=tickvalues,xticks=n_elements(zplotnames)-1,xtickname=zplotnames

xyouts,0.1,4e7,' h277',charsize=1.5,/data
