...
;# "MW1.1024g1bwK"," ", " "
;#
pro accrmode_changervir, haloidoutfile, lunit, wmap1=wmap1, skip=skip
...
mwrfits, allstruct, 'grp1.allgas.entropy.fits', /create

;Pass structure to find_smooth, to find eary and smoothly accreted gas particles
jump1: allstruct = mrdfits('grp1.allgas.entropy.fits',1)
...
find_shocked_changervir, allstruct, haloidoutfile
...
shock = mrdfits('shockedchange.iord.fits',0)
