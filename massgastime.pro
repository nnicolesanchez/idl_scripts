...
plot,dmtime*tunit,alltotal,xtit='Time (Gyr)',ytit='Cumulative BH Mass (M'+sunsymbol()+')',/ylog,yra=[100,1e8],xra=[0,14],xstyle=8 ;xstyle=1 forces range to my range
   oplot,clumpybhtimes*tunit,clumpytotal,color=125;,psym=3
   oplot,bhorbittime,bhorbitmass,lines=2,color=0
   oplot,coldbhtimes*tunit,coldtotal,lines=0,color=80;,psym=3
    if numshocked gt 0 then  oplot,shockedbhtimes*tunit,shockedtotal,lines=0,color=240;,psym=3
;   oplot,earlybhtimes*tunit,earlytotal,color=5;,psym=3

help,bhorbittime
help,bhorbitmass 

legend,['total BH mass','total gas','cold','shocked','clumpy'],lines=[2,0,0,0,0],color=[0,0,80,240,125],charsize=1,/right,/bottom

axis,xaxis=1,xtit='Redshift',xtickv=tickvalues,xticks=n_elements(zplotnames)-1,xtickname=zplotnames

;xyouts,0.1,4e6,' h258',charsize=1.5,/data
...
plot,dmtime*tunit,alltotal,xtit='Time (Gyr)',ytit='Cumulative BH Mass (M'+sunsymbol()+')',/ylog,yra=[1,1e7];,title='h258';,psym=3
