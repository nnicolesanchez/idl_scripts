...
h1clumpy = mrdfits('../../newgastracingfiles/newnew/clumpy.accr.iord.fits',0)
h1shocked = mrdfits('../../newgastracingfiles/newnew/shocked.iord.fits',0)
h1cold = mrdfits('../../newgastracingfiles/newnew/unshock.iord.fits',0)
h1early = mrdfits('../../newgastracingfiles/newnew/early.iord.fits',0)
h1smooth = mrdfits('../../newgastracingfiles/newnew/smooth.accr.iord.fits',0)
h1tracestep = mrdfits('../../newgastracingfiles/newnew/tracedtostep.fits',0)
h1accrz = mrdfits('../../newgastracingfiles/newnew/grp1.accrz.fits',0)
