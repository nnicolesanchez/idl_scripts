pro massgastime_comparisons,plotter=plotter
...
;should not equal all of them',n_elements(file.gasiord),' since file.gasiord is across all time'
...
oplot,time_Gyr,reverse(alltotal),xtit='Time [Gyr]',ytit='Cumulative BH Mass (M'+sunsymbol()+')',yra=[1000,1e9],/ylog,xra=[0,time_gyr[0]],xstyle=9;,color=0
