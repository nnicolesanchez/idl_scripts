pro luminosity_quies,plotter=plotter



;readcol,'out.dm',w,bhoird,w,delta,w,time,w,dm,w,dE,format='a,l,a,f,a,f,a,f,a,f'
readcol,'out.dm',w,bhiords,w,delta,w,dmtime,w,w,dm,w,w,w,w,w,dE,format='a,l,a,f,a,f,a,a,f,a,a,a,a,a,f'
...
plot,time,dE,/ylog,xtit='Time(Gyr)',ytit='Energy (ergs)',title='h277 primary BH'
