pro galgasfraction_quies,plotter=plotter,plottitle=plottitle,dolegend=dolegend
...
plot,redshifts,clumpymass/totalmass,xtit='Redshift',ytit='Gas Mass Fraction',xra=[4.5,0],xstyle=1,yra=[0,1],linestyle=0,title=plottitle
  oplot,redshifts,clumpymass/totalmass,color=90,linestyle=0;,psym=-1
  oplot,redshifts,coldmass/totalmass,color=60,linestyle=0
  oplot,redshifts,shockedmass/totalmass,color=210,linestyle=0
  oplot,redshifts,earlymass/totalmass,color=0,linestyle=0

if keyword_set(dolegend) then legend,['clumpy','unshocked','shocked','early'],colors=[90,60,210,0],lines=[0,0,0,0],/right,charsize=1


if keyword_set(dolegend) then legend,['BH','galaxy'],colors=[0,0],lines=[2,0],thick=[4,4],charsize=1,position=[2.9,0.95]
